package com.brightwrx.nameapp.service;
import java.io.File;
...
import com.brightwrx.nameapp.exception.FileArchiveServiceException;
...
public class FileArchiveService {
	...
	private @Value("${s3-bucket-name}") String S3_BUCKET_NAME;
