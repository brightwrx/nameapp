(function () {
    var springBootAws = angular.module('NameApp', ['ngRoute', 'angularUtils.directives.dirPagination']);
    ...
    springBootAws.controller('CreateCustomerCtrl', function ($scope, $location, $http) {
        ...
        self.add = function () {            
        	...
        	$scope.saving=true;
        	$http.post('/nameapp/customers', formData, {	
    ...
    springBootAws.controller('ViewCustomerCtrl', function ($scope, $http, $routeParams) {
        ...
        $http.get('/nameapp/customers/' + customerId).then(function onSuccess(response) {
    ...
    springBootAws.controller('ViewAllCustomersCtrl', function ($scope, $http) {
        ...
        $scope.dataLoading = true;
        $http.get('/nameapp/customers').then(function mySucces(response) {
        ...
        self.delete = function (customerId) {
        	...
        	$http.delete('/nameapp/customers/' + customerId).then(function onSucces(response) {
